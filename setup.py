...
long_description = "Library for measuring with Zmeter"
...
setup(name="Zmeter",
      version=_version,
      description="Library for measuring with Zmete",
      ...
      url="https://github.com/luciare/Zmeter",
      download_url="https://github.com/luciare/Zmeter",
      license="GPLv3",
